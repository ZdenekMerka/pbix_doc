...
id932(["Risk[Product ID]"]) --> id992(["Explanations[Product ID]"])
id8304(["Month[Month]"]) --> id13029(["Backorder Percentage[Month]"])
```
...
----
<p align="center">
Generated at 16.12.2023 21:38:23 by <a href='https://github.com/dop12/pbix_doc'>PBIX DOC PROJECT</a> Git version: 02a288a
</p>